...
assert property( seq6 |-> ( ##(64*25) ai.rdata==0)) else die("Didn't cycle to zero");
...
endsequence
assert property( test7_running |-> ##[1:(25*256)] ai.rdata==10 ##256 ai.rdata==11)
	else die("Not counting right");

//assert property( seq7 |-> ( ##(256*25) ai.rdata==0)) else die("Didn't cycle to zero");
...
endsequence
sequence seq88;
 test8_running==1 && $rose(ai.rdata==4);
endsequence
assert property( test8_running |-> ##[1:(55*1024)] ai.rdata==13 ##1024 ai.rdata==14)
	else die("Not counting right");

//assert property( seq8 |-> ( ##(1024*25) ai.rdata==0)) else die("Didn't cycle to zero");
